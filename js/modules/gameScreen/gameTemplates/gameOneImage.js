...
import {QuestionNums} from '../../../constants.js';
import header from '../../header-game/header';
  ...
  <section class="game">
    ...
    <form class="game__content  game__content--wide">
        ...
        <label class="game__answer  game__answer--photo">
            <input class="visually-hidden" name=${QuestionNums.FIRST_QUESTION} type="radio" value=${answers[0].type}>
            <span>Фото</span>
        </label>
        <label class="game__answer  game__answer--paint">
            <input class="visually-hidden" name=${QuestionNums.FIRST_QUESTION} type="radio" value=${answers[1]}>
            <span>Рисунок</span>
        </label>
        </div>
    </form>
